...
const GlobeIcon2 = ({ stroke, ...props }) => {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M5 12H19M15.25 12C15.25 16.5 13.243 19.25 12 19.25C10.757 19.25 8.75 16.5 8.75 12C8.75 7.5 10.757 4.75 12 4.75C13.243 4.75 15.25 7.5 15.25 12Z"
        stroke={stroke || theme.palette.color.primary}
        strokeWidth={1.5}
        strokeLinecap="round"
        strokeLinejoin="round"
